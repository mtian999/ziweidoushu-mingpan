...
export const TIERS_JA: Array<Tier> = [
  ...
  },
  {
    ...
    title: "カスタム",
    href: siteConfig.authors[0].twitter || "#",
    description: "将来のサポート機能、工事中...",
    price: "$998",
    features: ["運命チャート解釈", "工事中..."],
    buttonText: "お楽しみに",
    buttonColor: "default",
    buttonVariant: "flat",
  },
...
export const TIERS_ES: Array<Tier> = [
  ...
  },
  {
    ...
    title: "Personalizado",
    href: siteConfig.authors[0].twitter || "#",
    description: "Características de soporte futuras, En Construcción...",
    price: "$998",
    features: ["Interpretación del gráfico del destino", "En Construcción..."],
...
export const TIERS_RU: Array<Tier> = [
  ...
  },
  {
    ...
    href: siteConfig.authors[0].twitter || "#",
    description: "Функции поддержки в будущем, В процессе строительства...",
    price: "$998",
    features: ["Интерпретация диаграммы судьбы", "В процессе строительства..."],
